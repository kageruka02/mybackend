...
describe('POST /blogss by admin user', () => {
    it('should create a new blog post when authenticated as admin user', () => __awaiter(void 0, void 0, void 0, function* () {
        const blogData = {
            title: 'hello',
            author: 'admin_user',
            topictext: 'jfkjdkf',
...
describe('POST /blogss by normal user', () => {
    it('should not create a new blog post when authenticated as normal user', () => __awaiter(void 0, void 0, void 0, function* () {
        const blogData = {
            title: 'hello',
            author: 'normal_user',
            topictext: 'jfkjdkf',
...
describe('GET /blogss', () => {
    it("should get all the blogs", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(database_1.default)
            .get('/blogss')
            .set('Authorization', `Bearer ${userAuthToken}`)
            .expect(200);
