...
describe('DELETE /messages/:id', () => {
    ...
    it('should return 400 if the message id is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(database_1.default)
            .delete('/messages/invalidId')
            .expect(500);
    })).timeout(timeout);
    it('should delete all messages', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(database_1.default)
            .delete('/messages/deleteall')
            .expect(200);
    })).timeout(timeout);
...
describe('GET /messages/:id', () => {
    ...
    it('should get an existing message by ID', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(database_1.default)
